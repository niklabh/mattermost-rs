...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/marketplacemetering v1.36.5 // indirect
	...
	github.com/mattermost/mattermost-plugin-ai v1.14.0 // indirect
	github.com/mattermost/morph v1.1.0 // indirect
	github.com/mattermost/pdf v0.0.0-20260728101013-cd8a834041c4 // indirect
...
// Resolve the model package from the PINNED local clone, never from the module
// proxy. Fixtures must be generated from the same SHA recorded in MIGRATION.md;
